...
<%--<link rel="stylesheet" href="${APP_PATH}/static/css/images.css">--%>
...
<script type="text/javascript" src="${APP_PATH}/static/js/Images.js"></script>
...
<div class="container">
        ...
        <div class="col-md-9">
            <ul class="nav nav-pills">
                ...
                <shiro:hasRole name="admin">
                    ...
                    <li role="presentation" class="active"><a href="${APP_PATH}/page10">图片管理</a></li>
                </shiro:hasRole>
            </ul>
        </div>
        <div>
    ...
    <div class="row">
        <div class="col-md-3 col-md-offset-9">
            <button class="btn btn-primary" id="images_add_btn" data-toggle="modal"  data-target="#images_add">新增</button>
            <button class="btn btn-danger" id="images_del_btn">删除</button>
        </div>
    </div>
    <%--    表格--%>
    <div class="row">
        <div class="col-md-12">
            <table class="table table-hover" id="images_table">
                <thead>
                <tr>
                    <th class="col-md-2">
    ...
    <%--    页码--%>
    <div class="row">
        <div class="col-md-3 col-md-offset-3" id="images_pageinfo"></div>
        <div class="col-md-6" id="images_page"></div>
    </div>
</div>
<%--修改密码--%>
...
<%--新增--%>
<div class="modal fade" id="images_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="images_add_form">
                    <div class="form-group">
                        <label for="imagesFile_add" class="col-sm-2 control-label">添加</label>
                        <div class="col-sm-10">
                            <input type="file" id="imagesFile_add" name="imageFile" accept="image/jpg,image/jpeg,image/png,image/gif">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" id="images_save_btn">保存</button>
            </div>
        </div>
    </div>
</div>
