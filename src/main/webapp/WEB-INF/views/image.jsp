...
<script type="text/javascript" src="${APP_PATH}/static/js/image.js"></script>
...
<input type="hidden" id="isMain" value="yes" />
<div class="container">
    <%--    标题--%>
    <div class="row">
        <div class="col-md-11">
    ...
    <%--    按钮--%>
    <div class="row">
        <h4 align="center" class="col-md-2 col-md-offset-5">所有图片</h4>
